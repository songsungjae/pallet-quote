...
export default function App(){
  ...
  function downloadSample(){
    ...
    function toRangeName(cat){return cat.replace(/[^A-Za-z0-9가-힣]/g,"_");}
    ...
    // D열: 소분류 → INDIRECT(C2) 로 대분류별 Named Range 참조
    sheetXml+='<dataValidations count="2">'
      ...
      +`<dataValidation type="list" allowBlank="1" showDropDown="0" sqref="D2:D1000"><formula1>INDIRECT(C2)</formula1></dataValidation>`
      +'</dataValidations>';
    sheetXml+="</worksheet>";
