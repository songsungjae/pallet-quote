  ...
  return(
    <div>
      ...
      <div style={S.kpiGrid}>
        ...
        <KpiCard label="연간 총 포장비" value={kpiTotal>0?`₩${fmt(Math.round(kpiTotal/10000))}만`:"—"} unit={kpiTotal>0?`파렛트 ${fmt(Math.ceil(kpiAq/((kpiEstQ||kpiQpp)||1)))}개`:""}color={C.amber} sub="추정 단가 기준"/>
      </div>
